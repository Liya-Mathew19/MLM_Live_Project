...
<div id="print_area">
   <div class="card card-danger card-outline card-outline-danger">
      <div class="card-header">
	      <h4 class="card-title">DOWNLINE REPORT OF {{\App\Helper\PaymentHelper::bind_account_number($id)}}
               [ {{$monthName}},{{$year}} ]</b></h3></th></tr>
         </h4>
      </div>
      

      <div class="row mt-3" style="padding:17px">
			<div class="col-lg-12 grid-margin stretch-card">
				<div class="card ">
				   ...
				   <div class="card-body" >
              <font color="black"> Name : {{$account->name}}<br><br>
               Email : {{$account->email}} <br><br>
               Phone : {{$account->phone}} <br><br></font>
               </div>
            </div>
         </div>
      </div>
