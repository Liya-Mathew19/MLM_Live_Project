          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              @endphp
                ...
                <center><a href ="https://afpageneraltraders.com/afpa_subscription/public/payment_receipt/{{ $id }}" target="_blank">
                <button type="button" class="button button2">Click here to download the invoice</button></a></center>
